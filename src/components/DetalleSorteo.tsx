...
import {Card, Divider, MD3Colors, Text} from 'react-native-paper';
      ...
      <Card mode="elevated" theme={{roundness: 4}} style={estiloGlobal.mb10}>
        <Card.Content>
          {sorteo.titulo !== 'POZO EXTRA' ? (
            <View key={uuid.v4()} style={estilo.contenedorNumeros}>
              {arreNumeros.map((object, i) => {
                return (
                  <View key={i}>
                    <Card
                      ...
                      <View>
                        {object.ganadores === 'Vacante' ? (
                          ...
                          <View
                            ...
                            <Text
                              variant="headlineSmall"
                              style={{color: MD3Colors.primary70}}>
                              {object.ganadores}
                            </Text>
                          </View>
                        )}
